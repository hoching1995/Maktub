...
function createDiscription() {
    ...
    xhr.onload = function() {
        if (xhr.status === 200) {
            var responseObject = JSON.parse(xhr.responseText);
            var productName = responseObject.Accessories[itemNumber].Productname;
            var discription = responseObject.Accessories[itemNumber].description;
            var color = responseObject.Accessories[itemNumber].color;
            var price = responseObject.Accessories[itemNumber].Price;
            var id = responseObject.Accessories[itemNumber].Id;
            var item = responseObject.Accessories[itemNumber];
...
function createImages() {
    ...
    xhr.onload = function() {
        if (xhr.status === 200) {
            var responseObject = JSON.parse(xhr.responseText);
            var image = responseObject.cardHolder1;
